...
public class CommonController{
	...
	public R comment(HttpServletRequest request) throws Exception {
		...
		tableNames.add("discussyiliaoziyuan");
		tableNames.add("discussjinqueziyuan");
    ...
    */
    ...
    public void exportDatabaseTool(HttpServletResponse response)throws InterruptedException {
        ...
        try {
            ...
            String path = "D:\\system\\mysql5.7\\bin";
            String cmd = "mysqldump -h127.0.0.1 -uroot -P3307 -p123456 medicine";
            cmd = path +"/" + cmd;
