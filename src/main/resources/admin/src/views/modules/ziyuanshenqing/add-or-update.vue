	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.shenqingbianhao" label="申请编号" prop="shenqingbianhao" >
					<el-input v-model="ruleForm.shenqingbianhao" placeholder="申请编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="申请数量" prop="ziyuanshuliang" >
					<el-input v-model.number="ruleForm.ziyuanshuliang" placeholder="申请数量" clearable  :readonly="ro.ziyuanshuliang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="申请数量" prop="ziyuanshuliang" >
					<el-input v-model="ruleForm.ziyuanshuliang" placeholder="申请数量" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'" label="申请费用" prop="shenqingfeiyong" >
					<el-input v-model="shenqingfeiyong" placeholder="申请费用" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.shenqingfeiyong" label="申请费用" prop="shenqingfeiyong" >
					<el-input v-model="ruleForm.shenqingfeiyong" placeholder="申请费用" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.shenqingyuanyin" label="申请原因" prop="shenqingyuanyin"  class="textBox">
				<span class="text">{{ruleForm.shenqingyuanyin}}</span>
			</el-form-item>
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							if(objcross!=null) {
								...
								if(objcross.ziyuanshuliang<this.ruleForm.ziyuanshuliang){
							...
							await this.$http({
								url: `ziyuanshenqing/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.ziyuanshenqingCrossAddOrUpdateFlag = false;
											this.parent.search();
										}
									});
								} else {
